...
export function runTests(): void {
	...
	test('should update an application', () => {
		const g = createApplication()
		const projectDetailsField = GrantFieldAnswer.load(`${g!.id}.projectDetails`)!
		...
		const projectDetailsFieldUpdate = GrantFieldAnswer.load(`${g!.id}.projectDetails`)!
