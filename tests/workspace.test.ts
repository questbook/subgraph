...
export function runTests(): void {
	...
	test('should add the executed fund value to existing total grant funding disbursed', () => {
		...
		const event2 = new FundsTransferStatusUpdated(ev2.address, ev2.logIndex, ev2.transactionLogIndex, ev2.logType, ev2.block, ev2.transaction, ev2.parameters, ev2.receipt)
