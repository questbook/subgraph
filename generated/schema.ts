...
export class WorkspaceSafe extends Entity {
	...
	get workspace(): string {
		const value = this.get('workspace')
		return value!.toString()
	}
...
export class Partner extends Entity {
	...
	get partnerImageHash(): string | null {
		const value = this.get('partnerImageHash')
		if(!value || value.kind == ValueKind.NULL) {
			return null
		} else {
			return value.toString()
...
export class GrantField extends Entity {
	...
	get inputType(): string {
		const value = this.get('inputType')
		return value!.toString()
	}
	...
	get possibleValues(): Array<string> | null {
		const value = this.get('possibleValues')
		if(!value || value.kind == ValueKind.NULL) {
			return null
		} else {
...
export class Reward extends Entity {
	...
	get committed(): BigInt {
		const value = this.get('committed')
		return value!.toBigInt()
	}
...
export class RubricItem extends Entity {
	...
	get maximumPoints(): i32 {
		const value = this.get('maximumPoints')
		return value!.toI32()
	}
...
export class Rubric extends Entity {
	...
	get isPrivate(): boolean {
		const value = this.get('isPrivate')
		return value!.toBoolean()
	}
	...
	get createdAtS(): i32 {
		const value = this.get('createdAtS')
		return value!.toI32()
	}
	...
	get updatedAtS(): i32 {
		const value = this.get('updatedAtS')
		return value!.toI32()
	}
...
export class Review extends Entity {
	...
	get application(): string {
		const value = this.get('application')
		return value!.toString()
	}
	...
	get reviewerId(): string {
		const value = this.get('reviewerId')
		return value!.toString()
	}
	...
	get publicReviewDataHash(): string | null {
		const value = this.get('publicReviewDataHash')
		if(!value || value.kind == ValueKind.NULL) {
			return null
		} else {
			return value.toString()
...
export class Grant extends Entity {
	...
	get deadlineS(): i32 {
		const value = this.get('deadlineS')
		return value!.toI32()
	}
	...
	get acceptingApplications(): boolean {
		const value = this.get('acceptingApplications')
		return value!.toBoolean()
	}
	...
	get metadataHash(): string {
		const value = this.get('metadataHash')
		return value!.toString()
	}
	...
	get numberOfApplications(): i32 {
		const value = this.get('numberOfApplications')
		return value!.toI32()
	}
	...
	get applications(): Array<string> {
		const value = this.get('applications')
		return value!.toStringArray()
	}
	...
	get fundTransfers(): Array<string> {
		const value = this.get('fundTransfers')
		return value!.toStringArray()
	}
...
export class GrantReviewerCounter extends Entity {
	...
	get reviewerAddress(): Bytes {
		const value = this.get('reviewerAddress')
		return value!.toBytes()
	}
	...
	get pendingCounter(): i32 {
		const value = this.get('pendingCounter')
		return value!.toI32()
	}
	...
	get doneCounter(): i32 {
		const value = this.get('doneCounter')
		return value!.toI32()
	}
...
export class WorkspaceMember extends Entity {
	...
	get profilePictureIpfsHash(): string | null {
		const value = this.get('profilePictureIpfsHash')
		if(!value || value.kind == ValueKind.NULL) {
			return null
		} else {
			return value.toString()
	...
	get accessLevel(): string {
		const value = this.get('accessLevel')
		return value!.toString()
	}
	...
	get publicKey(): string | null {
		const value = this.get('publicKey')
		if(!value || value.kind == ValueKind.NULL) {
			return null
		} else {
			return value.toString()
	...
	get removedAt(): i32 {
		const value = this.get('removedAt')
		return value!.toI32()
	}
	...
	get lastReviewSubmittedAt(): i32 {
		const value = this.get('lastReviewSubmittedAt')
		return value!.toI32()
	}
	...
	get outstandingReviewIds(): Array<string> {
		const value = this.get('outstandingReviewIds')
		return value!.toStringArray()
	}
...
export class Workspace extends Entity {
	...
	get logoIpfsHash(): string {
		const value = this.get('logoIpfsHash')
		return value!.toString()
	}
	...
	get coverImageIpfsHash(): string | null {
		const value = this.get('coverImageIpfsHash')
		if(!value || value.kind == ValueKind.NULL) {
			return null
		} else {
			return value.toString()
	...
	get supportedNetworks(): Array<string> {
		const value = this.get('supportedNetworks')
		return value!.toStringArray()
	}
...
export class ApplicationMilestone extends Entity {
	...
	get amountPaid(): BigInt {
		const value = this.get('amountPaid')
		return value!.toBigInt()
	}
	...
	get feedbackDao(): string | null {
		const value = this.get('feedbackDao')
		if(!value || value.kind == ValueKind.NULL) {
			return null
		} else {
			return value.toString()
	...
	get feedbackDev(): string | null {
		const value = this.get('feedbackDev')
		if(!value || value.kind == ValueKind.NULL) {
			return null
		} else {
			return value.toString()
...
export class GrantApplicationReviewer extends Entity {
	...
	get assignedAtS(): i32 {
		const value = this.get('assignedAtS')
		return value!.toI32()
	}
...
export class GrantApplication extends Entity {
	...
	get applicantId(): Bytes {
		const value = this.get('applicantId')
		return value!.toBytes()
	}
	...
	get milestones(): Array<string> {
		const value = this.get('milestones')
		return value!.toStringArray()
	}
	...
	get reviewers(): Array<string> {
		const value = this.get('reviewers')
		return value!.toStringArray()
	}
	...
	get pendingReviewerAddresses(): Array<Bytes> {
		const value = this.get('pendingReviewerAddresses')
	...
	get doneReviewerAddresses(): Array<Bytes> {
		const value = this.get('doneReviewerAddresses')
		return value!.toBytesArray()
	}
	...
	get applicationReviewers(): Array<string> {
		const value = this.get('applicationReviewers')
		return value!.toStringArray()
	}
...
export class FundsTransfer extends Entity {
	...
	get milestone(): string | null {
		const value = this.get('milestone')
		if(!value || value.kind == ValueKind.NULL) {
			return null
		} else {
			return value.toString()
...
export class Notification extends Entity {
	...
	get recipientIds(): Array<Bytes> {
		const value = this.get('recipientIds')
		return value!.toBytesArray()
	}
